// Code generated by protoc-gen-go-grpc_protocol. DO NOT EDIT.
...
// is compatible with the grpc_protocol package it is being compiled against.
...
// It's only intended for direct use with grpc_protocol.RegisterService,
